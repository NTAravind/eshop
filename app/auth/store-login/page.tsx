    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950">
            ...
            <div className="absolute inset-0 z-0 opacity-30 dark:opacity-10" 
                style={{
                    backgroundImage: 'radial-gradient(#4f46e5 0.5px, transparent 0.5px), radial-gradient(#4f46e5 0.5px, #f8fafc 0.5px)',
                    backgroundSize: '20px 20px',
                    backgroundPosition: '0 0, 10px 10px'
                }}
            />

            <Card className="w-full max-w-md z-10 border-t-4 border-t-indigo-600 shadow-xl">
                <CardHeader className="space-y-1 text-center pb-8">
                    ...
                    <CardTitle className="text-2xl font-bold tracking-tight">Store Admin Portal</CardTitle>
    ...
    return (
        <div className="space-y-4">
            ...
            <form
                ...
                className="space-y-3"
            >
                <Button type="submit" className="w-full h-12 text-base bg-indigo-600 hover:bg-indigo-700 transition-colors" size="lg">
