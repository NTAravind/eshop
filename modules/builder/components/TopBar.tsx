...
import { useEditorStore, selectCanUndo, selectCanRedo } from '@/modules/builder/editor-store';
import { cn } from '@/shared/utils';

import type { DeviceType, EditorMode, ProductContext } from '@/types/storefront-builder';
import { PreviewProductSelector } from './PreviewProductSelector';
...
interface TopBarProps {
    ...
    previewProducts?: ProductContext[];
}
            ...
            {/* Preview Product Selector */}
            {
                previewProducts.length > 0 && (
                    <div className="hidden lg:block border-l pl-4 ml-2">
                        <PreviewProductSelector products={previewProducts} />
                    </div>
                )
            }
