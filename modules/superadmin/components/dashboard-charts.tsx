...
export function RevenueChart({ data, isLoading, currency = 'USD' }: OrdersChartProps) {
    if (isLoading) {
        return (
            <Card>
                <CardHeader>
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={chartData}>
                        ...
                        <YAxis
                            className="text-xs"
                            tick={{ fill: 'hsl(var(--muted-foreground))' }}
                            tickFormatter={(value) => formatVal(value)}
                        />
                        <Tooltip
                            contentStyle={{
                            ...
                            formatter={(value: number | undefined) => [formatVal(value ?? 0), 'Revenue']}
                        />
                        <Line
                            type="monotone"
                            dataKey="value"
