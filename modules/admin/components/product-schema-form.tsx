...
export const ProductSchemaForm: React.FC<ProductSchemaFormProps> = ({
    ...
    const form = useForm<SchemaFormValues>({
        ...
        defaultValues: initialData ? {
            ...
            name: "",
            fields: [{ key: "", label: "", type: "text", required: false, isFilterable: false, options: "" }]
        },
    });
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Button
                                ...
                                variant="outline"
                                size="sm"
                                onClick={() => append({ key: "", label: "", type: "text", required: false, isFilterable: false, options: "" })}
                            >
                            ...
                            <Card key={field.id}>
                                <CardContent className="p-4 grid grid-cols-12 gap-4 items-start">
                                    ...
                                    <div className="col-span-1">
                                        <FormField
                                            control={form.control}
                                            name={`fields.${index}.isFilterable`}
                                            render={({ field }) => (
                                                <FormItem className="flex flex-row items-center space-x-2 space-y-0 pt-8">
                                                    <FormControl>
                                                        <Checkbox
                                                    ...
                                                    <FormLabel className="font-normal">Filterable</FormLabel>
                                                </FormItem>
                                            )}
                                        />
                                    </div>
