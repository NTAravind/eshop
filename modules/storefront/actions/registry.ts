...
export const actionRegistry = {
    ...
    UPDATE_QUANTITY: {
        ...
        bindablePayload: ['variantId', 'quantity'] as const,
    },
    ...
    GO_TO_CHECKOUT: {
        ...
        bindablePayload: ['storeSlug'] as const,
    },

    PLACE_ORDER: {
        displayName: 'Place Order',
        description: 'Submit the current checkout and place the order',
        payloadSchema: z.object({
            checkoutData: z.record(z.string(), z.unknown()).optional(),
        }),
        bindablePayload: ['checkoutData'] as const,
    },
